...
namespace WIP_Polygon {
	void ConstructFromPointSet(std::vector<float> _verts, glm::vec3& _scale) {
		float x{};
		float y{};
		float z{};
	...
	void ExtremePointsAlongDirection(glm::vec3 dir, std::vector<float> points, glm::vec3* min_pt, glm::vec3* max_pt) {
