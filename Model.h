...
private:
	...
	std::vector<Texture> loadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName) {
		...
		//load white texture (1x1 white pixel) as default texture for cases where mesh has no texture and would otherwise render black.
		whiteTexture.id = TextureFromFile("white.png", "C:/OPENGL/textures", false);
		whiteTexture.type = "white";
		whiteTexture.path = "white.png";
